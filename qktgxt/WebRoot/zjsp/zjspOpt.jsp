...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form action="<%=path %>/zjsp?type=zjspOpt" name="formAdd" method="post">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
							...
							<td width="75%" bgcolor="#FFFFFF" align="left">
								<textarea rows="8" cols="16" name="zjyj"></textarea>
							</td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="25%" bgcolor="#FFFFFF" align="right">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
							  ...
							  <input type="button" onclick="zjspTijiao(<%=Tgzt.ZJTY %>)" value="同意"/>
							  <input type="button" onclick="zjspTijiao(<%=Tgzt.ZJTH %>)" value="不同意"/>
